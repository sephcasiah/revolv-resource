...
# Embedded file name: d:\BuildAgent\work\f83b6632d72c7b5b\branches\release\EVE-TRANQUILITY\carbon\src\stackless\Lib\json\encoder.py
...
class JSONEncoder(object):
    ...
    def iterencode(self, o, _one_shot=False):
        ...
        if _one_shot and c_make_encoder is not None and not self.indent and not self.sort_keys:
            ...
            if ccpEncoder:
                maker = ccpEncoder.IterNodeMaker(markers, self.default, _encoder, self.indent, floatstr, self.key_separator, self.item_separator, self.sort_keys, self.skipkeys, _one_shot)
                _iterencode = maker._make_iterencode_ccp()
            else:
